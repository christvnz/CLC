...
const Footer = () => {
  return (
    <FooterContainer className="flex-column grid grid-cols-2 md:gap-12">
      <WordLogo />
      ...
      <div className="col-span-2 md:order-1 md:col-span-1">
        <TextP className="mt-6">
          ...
          other establishments. This platform also features articles from our writers showcasing top
          spots, opinions, and in-depth restaurant features, making it a valuable resource for
